...
public class SpscPipeWriterSpliceTests
{
    ...
    [Fact]
    public void Splice_BufferWithMemoryLengthZero_NoArg_DisposesAndReturns()
    {
    ...
    // ---------- Post-Splice interactions with the rest of the writer surface ----------
    ...
    [Fact]
    public void Splice_AfterGetMemoryWithZeroBuffered_FreezesEmptyRentedSegment()
    {
    ...
    public void BackToBackSplices_NoEmptyRentedTailsBetweenDonations()
    {
        ...
        pipe.Writer.Splice(o1);
        pipe.Writer.Splice(o2);
    ...
    [Fact]
    public async Task Splice_AfterRecycle_ReusesShellFromFreelist()
    {
    ...
    public async Task ShellFreelist_RespectsCap()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            owners.Add(o);
            pipe.Writer.Splice(o);
        }
        // Active tail (last Splice) prevents recycle of the 5th; first 4 are recyclable.
    ...
    public async Task ReadResultBufferContent_IncludesDonatedBytes_InCorrectPosition()
    {
        ...
        pipe.Writer.Splice(donatedOwner);
